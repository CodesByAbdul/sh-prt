...
/**
 * addnode_ - adds a node to the start of the list
 ...
 * Return: size of list
 */
list_t *addnode_(list_t **head, const char *str, int num)
{
	list_t *new_head;
...
/**
 * freelist_ - frees all nodes of a list
 * @head_ptr: address of pointer to head node
 *
 * Return: void
 */
void freelist_(list_t **head_ptr)
{
